...
public final class AppState: ObservableObject {
    @AppStorage("fxfile_dual_pane_enabled") public var dualPaneEnabled: Bool = true
    ...
    @AppStorage("fxfile_confirm_delete") public var confirmBeforeDelete: Bool = true
    @AppStorage("fxfile_show_hidden_global") public var showHiddenFilesGlobal: Bool = false {
        didSet {
