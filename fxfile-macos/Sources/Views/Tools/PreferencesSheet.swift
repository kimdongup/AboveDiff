...
public struct PreferencesSheet: View {
    ...
    @AppStorage("fxfile_confirm_delete") private var confirmDelete: Bool = true
    @AppStorage("fxfile_show_hidden_global") private var showHidden: Bool = false
    @AppStorage("fxfile_calc_folder_sizes") private var calcFolderSizes: Bool = false
