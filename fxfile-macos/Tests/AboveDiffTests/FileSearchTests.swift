...
final class FileSearchTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        tempDirectory = tempBase.appendingPathComponent("fxfile_search_tests_\(UUID().uuidString)")
    ...
    private func setupSearchTree() throws {
        ...
        struct Service {
            let secretApiKey = "fxfile-secure-key"
        }
        """
    ...
    func testContentSearchSnippetAndLineNumber() throws {
        ...
        XCTAssertTrue(match.matchSnippet?.contains("fxfile-secure-key") == true)
    }
