...
final class ChecksumTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        tempDirectory = tempBase.appendingPathComponent("fxfile_checksum_tests_\(UUID().uuidString)")
    ...
    func testVerifyChecksum() throws {
        ...
        let content = "fxfile macOS checksum test payload"
    ...
    func testChecksumExportGeneration() {
        ...
        XCTAssertTrue(sfvExport.contains("; Generated by fxfile (macOS)"))
